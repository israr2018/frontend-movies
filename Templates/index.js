  ...
  render() {
    return (
      <div
        className={
          this.props.className +
          " vurox-admin-primary-bg vurox-admin-components-block overview-hidden"
        }
        style={{ backgroundColor: this.props.fillbg }}
      >
        {this.props.children}
      </div>
    );
...
export class VuroxAdvancedTableHeading extends React.Component {
  ...
  render() {
    return (
      <div
        className="vurox-box-headings vurox-stats-box has-bg-img-right"
        style={{
  ...
  render() {
    return (
      <div
        className={
          this.props.className +
          " vurox-horizontal-links boxed vurox-admin-secondary-bg"
        }
      >
        <ul>{this.props.children}</ul>
      </div>
